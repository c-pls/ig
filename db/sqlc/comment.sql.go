...
type GetListOfCommentParams struct {
	ParentID  string `json:"parent_id"`
	Limit     int32  `json:"limit"`
	CreatedAt string `json:"created_at"`
}

func (q *Queries) GetListOfComment(ctx context.Context, arg GetListOfCommentParams) ([]Comment, error) {
	rows, err := q.db.QueryContext(ctx, getListOfComment, arg.ParentID, arg.Limit, arg.CreatedAt)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
